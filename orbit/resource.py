...
from orbit.framing import buildAccept
from orbit.websockets import WebSocketServerFactory
...
class WebSocketResource(object):
	...
	def render(self, request):
		...
		try:
			...
			self.keyword is not None and request.args.has_key(self.keyword)) else None)
		except:
			# failed to locate
			request.setResponseCode(400)
			return b""
